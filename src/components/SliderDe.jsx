  ...
  <section id="slider2" className="slider slider-2">
    <div id="carouselExampleIndicators" className="carousel slide carousel-fade" data-bs-ride="carousel">
      <div className="carousel-indicators">
        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Folien 1"></button>
        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Folien 2"></button>
        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Folien 3"></button>
      </div>
              ...
              <div className="row">
                <div className="col-xl-10">
                  <div className="slide__content">
                    <h2 className="slide__title">CNC Vertikalfräsen</h2>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="slide-item align-v-h bg-overlay" style={{backgroundImage: "url('./src/assets/img/sliders/2.jpg')", backgroundSize: "cover", backgroundPosition: "center center"}}>
            <div className="container">
              <div className="row">
                <div className="col-xl-10">
                  <div className="slide__content">
                    <h2 className="slide__title">CNC Horizontal-Drehmaschine</h2>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="slide-item align-v-h bg-overlay" style={{backgroundImage: "url('./src/assets/img/sliders/3.jpg')", backgroundSize: "cover", backgroundPosition: "center center"}}>
            <div className="container">
              <div className="row">
                <div className="col-xl-10">
                  <div className="slide__content">
                    <h2 className="slide__title">Manuelle Drehmaschine</h2>
                  </div>
                </div>
              </div>
            </div>
