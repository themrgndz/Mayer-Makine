        ...
        <div className="row align-items-center">
          <div className="col-sm-12">
            <div className="footer__copyright">
              <span><b>TESAN</b> TESAN GLOBAL ENGINEERING INC.</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-sm-12">
            <ul className="contact__list list-unstyled">
              <li><i className="fa fa-location-arrow"></i><span>Karadenizliler Mah. Kahraman St. Door No: 13 /1 Başiskele KOCAELİ</span></li>
